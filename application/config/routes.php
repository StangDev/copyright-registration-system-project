...
$route['controlpanel/download/get_form_bydownloadByid/(:any)'] = 'Controlpanels/download_document_success_getByid';
...
$route['controlpanel/document/approved/form/disapproved'] = 'Document/approved_disapproved';
